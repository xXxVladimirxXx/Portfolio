...
<div class="content-block">
    <div class="content-lg container">
                ...
                <?php while ( have_posts() ) : the_post(); ?>
                    ...
                    <div class="pager-area col-md-4">
                        ...
                        <div class="rating-area">
                            <ul class="tag">
                                <li>Категории: > <?php the_category(' / '); ?></li>
                            </ul>
                        </div><!--/rating-area-->
                    </div>
                <?php endwhile; ?>
        ...
        <div class="media commnets">
            ...
            <h4 class="media-heading">Автор статьи: <?php the_author(); ?></h4>
            <div class="media-body">

                    <ul class="sinlge-post-meta">
                        <li><i class="fa fa-clock-o"></i>Время: <?php the_time(); ?></li>
                        <li><i class="fa fa-calendar"></i>Дата: <?php the_date(); ?></li>
                    </ul>
